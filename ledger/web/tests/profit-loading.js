...
window.fetch=async url=>{
  ...
  return new Response(JSON.stringify({store_id:'s',period:'2026-06',run_id:1,person_id:'a',person:'测试',products:rows,sales_pending_products:pending?['p0']:[],excluded_product_ids:[],commission_trial:72}),{headers:{'Content-Type':'application/json'}})
}
