...
@media(max-width:640px){.fields{grid-template-columns:1fr;gap:0}.allocation-head,.allocation-row{grid-template-columns:minmax(0,1fr) 84px 96px 32px;gap:7px}.percentage input{width:70px!important}.dates summary span{display:block;margin:6px 0}}
</style>
