import{ad as j,ae as E,af as v,ag as H,Q as N,R as b,a4 as O,ah as V,F as A,ai as F,aj as w,I as k,ak as I,al as y}from"./index-BeKcLP5W.js";let S=!1;function L(){if(j&&window.CSS&&!S&&(S=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function T(e){const{heightSmall:i,heightMedium:r,heightLarge:s,borderRadius:a}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:a,heightSmall:i,heightMedium:r,heightLarge:s}}const $={common:E,self:T},K=v([H("skeleton",`
 height: 1em;
 width: 100%;
 transition:
