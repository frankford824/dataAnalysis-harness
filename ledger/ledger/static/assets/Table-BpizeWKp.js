import{R as W,aq as t,S as o,T as C,ay as v,aA as F,bc as I,bd as q,U as A,V as D,Y as K,Z as z,aB as N,aC as U,I as f,$ as x}from"./index-BQVQ0l1i.js";const Y={thPaddingSmall:"6px",thPaddingMedium:"12px",thPaddingLarge:"12px",tdPaddingSmall:"6px",tdPaddingMedium:"12px",tdPaddingLarge:"12px"};function Z(e){const{dividerColor:r,cardColor:a,modalColor:s,popoverColor:l,tableHeaderColor:c,tableColorStriped:b,textColor1:p,textColor2:g,borderRadius:n,fontWeightStrong:d,lineHeight:i,fontSizeSmall:h,fontSizeMedium:m,fontSizeLarge:u}=e;return Object.assign(Object.assign({},Y),{fontSizeSmall:h,fontSizeMedium:m,fontSizeLarge:u,lineHeight:i,borderRadius:n,borderColor:t(a,r),borderColorModal:t(s,r),borderColorPopover:t(l,r),tdColor:a,tdColorModal:s,tdColorPopover:l,tdColorStriped:t(a,b),tdColorStripedModal:t(s,b),tdColorStripedPopover:t(l,b),thColor:t(a,c),thColorModal:t(s,c),thColorPopover:t(l,c),thTextColor:p,tdTextColor:g,thFontWeight:d})}const G={common:W,self:Z},J=o([C("table",`
 ...
 `),o("td",`
 background-color: var(--n-td-color-popover);
 `)]))]),Q=Object.assign(Object.assign({},z.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:String}),oo=A({name:"Table",props:Q,setup(e){const{mergedClsPrefixRef:r,inlineThemeDisabled:a,mergedRtlRef:s,mergedComponentPropsRef:l}=K(e),c=f(()=>{var d,i;return e.size||((i=(d=l?.value)===null||d===void 0?void 0:d.Table)===null||i===void 0?void 0:i.size)||"medium"}),b=z("Table","-table",J,G,e,r),p=N("Table",s,r),g=f(()=>{const d=c.value,{self:{borderColor:i,tdColor:h,tdColorModal:m,tdColorPopover:u,thColor:P,thColorModal:S,thColorPopover:R,thTextColor:M,tdTextColor:k,borderRadius:T,thFontWeight:B,lineHeight:$,borderColorModal:y,borderColorPopover:_,tdColorStriped:w,tdColorStripedModal:L,tdColorStripedPopover:O,[x("fontSize",d)]:V,[x("tdPadding",d)]:j,[x("thPadding",d)]:E},common:{cubicBezierEaseInOut:H}}=b.value;return{"--n-bezier":H,"--n-td-color":h,"--n-td-color-modal":m,"--n-td-color-popover":u,"--n-td-text-color":k,"--n-border-color":i,"--n-border-color-modal":y,"--n-border-color-popover":_,"--n-border-radius":T,"--n-font-size":V,"--n-th-color":P,"--n-th-color-modal":S,"--n-th-color-popover":R,"--n-th-font-weight":B,"--n-th-text-color":M,"--n-line-height":$,"--n-td-padding":j,"--n-th-padding":E,"--n-td-color-striped":w,"--n-td-color-striped-modal":L,"--n-td-color-striped-popover":O}}),n=a?U("table",f(()=>c.value[0]),g,e):void 0;return{rtlEnabled:p,mergedClsPrefix:r,cssVars:a?void 0:g,themeClass:n?.themeClass,onRender:n?.onRender}},render(){var e;const{mergedClsPrefix:r}=this;return(e=this.onRender)===null||e===void 0||e.call(this),D("table",{class:[`${r}-table`,this.themeClass,{[`${r}-table--rtl`]:this.rtlEnabled,[`${r}-table--bottom-bordered`]:this.bottomBordered,[`${r}-table--bordered`]:this.bordered,[`${r}-table--single-line`]:this.singleLine,[`${r}-table--single-column`]:this.singleColumn,[`${r}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}});export{oo as _};
