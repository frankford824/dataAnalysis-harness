import{ac as j,ad as E,ae as v,af as H,Q as N,R as b,a3 as O,ag as V,F as A,ah as F,ai as w,I as k,aj as I,ak as y}from"./index-C38XQd5t.js";let S=!1;function L(){if(j&&window.CSS&&!S&&(S=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function T(e){const{heightSmall:i,heightMedium:r,heightLarge:s,borderRadius:a}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:a,heightSmall:i,heightMedium:r,heightLarge:s}}const $={common:E,self:T},K=v([H("skeleton",`
 height: 1em;
 width: 100%;
 transition:
