import{Q as C,G as h,w as k,R as r,I as v,a1 as B,aN as S,ah as s,bA as A,ai as f,bB as I,aG as d,aH as _,aU as F,bC as M,bD as W,ag as D,ba as z,b3 as X,bE as V,bh as q,bF as G,ak as L,al as E,o as H,aO as U,aP as j,bG as Z,am as K,bH as Q}from"./index-DywVq3Zh.js";const O=C({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=h(null),i=h(e.value),l=h(e.value),t=h("up"),a=h(!1),m=v(()=>a.value?`${e.clsPrefix}-base-slot-machine-current-number--${t.value}-scroll`:null),g=v(()=>a.value?`${e.clsPrefix}-base-slot-machine-old-number--${t.value}-scroll`:null);k(S(e,"value"),(n,u)=>{i.value=u,l.value=n,B(N)});function N(){const n=e.newOriginalNumber,u=e.oldOriginalNumber;u===void 0||n===void 0||(n>u?w("up"):u>n&&w("down"))}function w(n){t.value=n,a.value=!1,B(()=>{var u;(u=o.value)===null||u===void 0||u.offsetWidth,a.value=!0})}return()=>{const{clsPrefix:n}=e;return r("span",{ref:o,class:`${n}-base-slot-machine-number`},i.value!==null?r("span",{class:[`${n}-base-slot-machine-old-number ${n}-base-slot-machine-old-number--top`,g.value]},i.value):null,r("span",{class:[`${n}-base-slot-machine-current-number`,m.value]},r("span",{ref:"numberWrapper",class:[`${n}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${n}-base-slot-machine-current-number__inner--not-number`]},l.value)),i.value!==null?r("span",{class:[`${n}-base-slot-machine-old-number ${n}-base-slot-machine-old-number--bottom`,g.value]},i.value):null)}}}),{cubicBezierEaseOut:x}=A;function J({duration:e=".2s"}={}){return[s("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${x},
 max-width ${e} ${x},
 transform ${e} ${x}
 ...
 right: unset;
 left: 0;
 `)])])])])]),ae=C({name:"BaseSlotMachine",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],default:0},max:{type:Number,default:void 0},appeared:{type:Boolean,required:!0}},setup(e){F("-base-slot-machine",ee,S(e,"clsPrefix"));const o=h(),i=h(),l=v(()=>{if(typeof e.value=="string")return[];if(e.value<1)return[0];const t=[];let a=e.value;for(e.max!==void 0&&(a=Math.min(e.max,a));a>=1;)t.push(a%10),a/=10,a=Math.floor(a);return t.reverse(),t});return k(S(e,"value"),(t,a)=>{typeof t=="string"?(i.value=void 0,o.value=void 0):typeof a=="string"?(i.value=t,o.value=void 0):(i.value=t,o.value=a)}),()=>{const{value:t,clsPrefix:a}=e;return typeof t=="number"?r("span",{class:`${a}-base-slot-machine`},r(M,{name:"fade-up-width-expand-transition",tag:"span"},{default:()=>l.value.map((m,g)=>r(O,{clsPrefix:a,key:l.value.length-g-1,oldOriginalNumber:o.value,newOriginalNumber:i.value,value:m}))}),r(W,{key:"+",width:!0},{default:()=>e.max!==void 0&&e.max<t?r(O,{clsPrefix:a,value:"+"}):null})):r("span",{class:`${a}-base-slot-machine`},t)}}});function te(e){const{errorColor:o,infoColor:i,successColor:l,warningColor:t,fontFamily:a}=e;return{color:o,colorInfo:i,colorSuccess:l,colorError:o,colorWarning:t,fontSize:"12px",fontFamily:a}}const ne={common:D,self:te},oe=s([s("@keyframes badge-wave-spread",{from:{boxShadow:"0 0 0.5px 0px var(--n-ripple-color)",opacity:.6},to:{boxShadow:"0 0 0.5px 4.5px var(--n-ripple-color)",opacity:0}}),f("badge",`
 display: inline-flex;
 position: relative;
 ...
 top: 0;
 bottom: 0;
 `)])])]),ie=Object.assign(Object.assign({},E.props),{value:[String,Number],max:Number,dot:Boolean,type:{type:String,default:"default"},show:{type:Boolean,default:!0},showZero:Boolean,processing:Boolean,color:String,offset:Array}),se=C({name:"Badge",props:ie,setup(e,{slots:o}){const{mergedClsPrefixRef:i,inlineThemeDisabled:l,mergedRtlRef:t}=L(e),a=E("Badge","-badge",oe,ne,e,i),m=h(!1),g=()=>{m.value=!0},N=()=>{m.value=!1},w=v(()=>e.show&&(e.dot||e.value!==void 0&&!(!e.showZero&&Number(e.value)<=0)||!Z(o.value)));H(()=>{w.value&&(m.value=!0)});const n=U("Badge",t,i),u=v(()=>{const{type:b,color:c}=e,{common:{cubicBezierEaseInOut:p,cubicBezierEaseOut:R},self:{[K("color",b)]:$,fontFamily:Y,fontSize:T}}=a.value;return{"--n-font-size":T,"--n-font-family":Y,"--n-color":c||$,"--n-ripple-color":c||$,"--n-bezier":p,"--n-ripple-bezier":R}}),y=l?j("badge",v(()=>{let b="";const{type:c,color:p}=e;return c&&(b+=c[0]),p&&(b+=Q(p)),b}),u,e):void 0,P=v(()=>{const{offset:b}=e;if(!b)return;const[c,p]=b,R=typeof c=="number"?`${c}px`:c,$=typeof p=="number"?`${p}px`:p;return{transform:`translate(calc(${n?.value?"50%":"-50%"} + ${R}), ${$})`}});return{rtlEnabled:n,mergedClsPrefix:i,appeared:m,showBadge:w,handleAfterEnter:g,handleAfterLeave:N,cssVars:l?void 0:u,themeClass:y?.themeClass,onRender:y?.onRender,offsetStyle:P}},render(){var e;const{mergedClsPrefix:o,onRender:i,themeClass:l,$slots:t}=this;i?.();const a=(e=t.default)===null||e===void 0?void 0:e.call(t);return r("div",{class:[`${o}-badge`,this.rtlEnabled&&`${o}-badge--rtl`,l,{[`${o}-badge--dot`]:this.dot,[`${o}-badge--as-is`]:!a}],style:this.cssVars},a,r(X,{name:"fade-in-scale-up-transition",onAfterEnter:this.handleAfterEnter,onAfterLeave:this.handleAfterLeave},{default:()=>this.showBadge?r("sup",{class:`${o}-badge-sup`,title:V(this.value),style:this.offsetStyle},q(t.value,()=>[this.dot?null:r(ae,{clsPrefix:o,appeared:this.appeared,max:this.max,value:this.value})]),this.processing?r(G,{clsPrefix:o}):null):null}))}});export{se as _};
